...
import { GitBranch, Twitter, Github, Heart } from 'lucide-react';
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
                ...
                <div>
                    ...
                    <ul className="space-y-3 text-sm text-brand-muted">
                        <li><Link href="/" className="hover:text-brand-accent transition-colors">検索</Link></li>
                        <li><Link href="/" className="hover:text-brand-accent transition-colors">ランキング</Link></li>
                        <li><Link href="/login" className="hover:text-brand-accent transition-colors">企業向けプラン</Link></li>
                    </ul>
                </div>
                <div>
                ...
                <div>
                    ...
                    <div className="flex space-x-4">
                        <a href="#" className="text-brand-muted hover:text-foreground transition-colors bg-brand-panel p-2 rounded-lg border border-brand-border hover:border-brand-accent" aria-label="Twitter">
                            <Twitter className="w-5 h-5" />
                        </a>
                        <a href="#" className="text-brand-muted hover:text-foreground transition-colors bg-brand-panel p-2 rounded-lg border border-brand-border hover:border-brand-accent" aria-label="GitHub">
                            <Github className="w-5 h-5" />
                        </a>
                        <a href="#" className="text-brand-muted hover:text-foreground transition-colors bg-brand-panel p-2 rounded-lg border border-brand-border hover:border-brand-accent" aria-label="Discord">
                            {/* Discord Icon SVG */}
